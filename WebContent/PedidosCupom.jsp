...
<html>
    ...
    <body style="background-color: whitesmoke">
        <form method="post" action="ConsultarTroca2"> 
            <input type="text" value=ConsultarTrocaCupom hidden="true" name="operacao"/>
            <div class="container">
        ...
        <div class="container">
      	<c:if test="${pedidos.isEmpty() eq true}">
        	<div class="alert alert-info" style="margin-top: 2%">Nenhuma TROCA autorizada foi encontrada!</div>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel panel-body">
                        <table class="table table-bordered text-center table-striped table-responsive">
                            ...
                            <td style="background-color: #66afe9">Gerar Cupom</td>
                            ...
                            <c:forEach var="pedido" items="${requestScope.pedidos}" >
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
										<c:choose>
                                            <c:when test="${pedido.status eq 'Troca Autorizada'}">
                                                <form method="post" action="TrocaProduto3">
                                                    <input type="text" name="txtIdEntrega" value="${pedido.entrega.id}" hidden="true" />                                               
                                                    <input type="text" name="operacao" value="Trocar2" hidden="true"/>
                                                    <input type="text" name="txtIdPedido" value="${pedido.id}" hidden="true"/>
                                                    <input type="submit" class="btn btn-link" value="${pedido.status}"  title="Gerar Cupom!"/>
                                                </form>
                                            </c:when>
                                            <c:otherwise>
                                                ${pedido.status}
