...
<title>Relatórios de Vendas por Estado (L. Bruto)</title>
</head>
<body>
<jsp:useBean id="graficoDS" class="meraki.com.br.domain.RelatorioClientesEstado"/>
<jsp:setProperty name="graficoDS" property="*"/>
		
<center><h3>GRÁFICOS DE LINHAS</h3></center>
		
	<!-- GRÁFICO LINHAS E COLUNA -->
		<cewolf:chart id="grafico1" title="Gastos por estado - Gráfico de Coluna H" type="stackedhorizontalbar" 
				xaxislabel="Mês" yaxislabel="Valor Gasto">
		...
		<cewolf:chart id="grafico2" title="Gastos por estado - Gráfico de Coluna H" type="horizontalbar3d" 
				xaxislabel="Mês" yaxislabel="Valor Gasto">
		    <cewolf:gradientpaint>
		        <cewolf:point x="0" y="0" color="#FBFBFB" />
		        <cewolf:point x="350" y="0" color="#F3F3F3" />
		...
		<!-- GRÁFICO COLUNA 3D -->
		<cewolf:chart id="grafico3" title="Gastos por estado - Gráfico de Coluna V" type="verticalbar3d" 
				xaxislabel="Mês" yaxislabel="Valor Gasto">
		    <cewolf:gradientpaint>
		        <cewolf:point x="0" y="0" color="#FBFBFB" />
		        <cewolf:point x="350" y="0" color="#F3F3F3" />
