...
<title>Relatórios de Vendas por Mês (Qtde. Compras)</title>
</head>
<body>
<jsp:useBean id="graficoDS" class="meraki.com.br.domain.RelatorioClientesCompras"/>
...
<center><h3>GRÁFICOS DE LINHAS</h3></center>
	...
	<!-- GRÁFICO LINHAS E COLUNA -->
		<cewolf:chart id="grafico1" title="Gastos por idade - Gráfico de Coluna H" type="stackedhorizontalbar" 
				xaxislabel="Mês" yaxislabel="Qtde de compras">
