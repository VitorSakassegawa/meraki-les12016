...
<title>Relatórios de Vendas por Mês (L. Bruto)</title>
</head>
<body>
<jsp:useBean id="graficoDS" class="meraki.com.br.domain.RelatorioClientes"/>

<%-- <jsp:useBean id="graficoDS" class="meraki.com.br.controle.web.vh.impl.RelatorioVHWeb"/>  --%>
